...
\begin{itemize}
\item Chapter \ref{sec:org46d8cad} shows how coinductive types can be defined.
Here, we will define the stream and function type, as well as some
functions on the stream.

\item We will see in Chapter \ref{sec:orgf1de54b} how
...
\item In Chapter \ref{sec:org9d82899} we
...
\item We will then in Chapter \ref{sec:orge4f7b96} explain how this theory is
...
In Section \ref{sec:org29a9483} we will look at the implementation of
...
this the new way uses negative coinductive types. In Section \ref{sec:org8d60879}
...
types. We will explain them in Section \ref{sec:org66c6978}.
\section{Coinductive Types in Coq}
\label{sec:org29a9483}
...
described in section \ref{sec:org1b1645f}. The newer and recommended one is
described in Section \ref{sec:orge1c55d1}. They are defined using
...
\label{sec:org8d60879}
In Agda coinductive types were first also introduced as positive types. In
Section \ref{sec:org164f774} we will look at them in
detail. In Section \ref{sec:org09ba014} we describe the correct
...
natural numbers with one additional element, infinity. See \ref{sec:orga355351}
...
We will give the rules for the theory in Section \ref{sec:orgb757700} and a detailed
explanation of reduction in \ref{sec:org6fce095}.

\chapter{Implementation}
\label{sec:orge4f7b96}
...
In Section \ref{sec:org2792a2c} we will develop the abstract syntax of our language
from the raw syntax in the paper. Then, we rewrite the typing rules in \ref{sec:orgb757700}. At last we look at the implementation of reduction in \ref{sec:org6fce095}.
\section{Abstract Syntax}
\label{sec:org2792a2c}
...
\ref{sec:orgc518036}. We will also be able to bind expressions to names. In Section
\ref{sec:org31dd4f8} we will define the syntax of expressions. This will mostly be in
...
Con/Destructors to identify them. In the following Section \ref{sec:org250e33d}, we will
see how the examples from the paper look in our concrete syntax.
\subsection{Declarations}
\label{sec:orgc518036}
...
describe in Section \ref{sec:orga82274a}. $\mathtt{GlobalExprVar}$\;refers to variables from
...
\DisplayProof
\end{center}
\(\longrightarrow_T\) is defined in Section \ref{sec:org6fce095}.
...
We will show the proof in appendix \ref{sec:org8b35473}.
