...
** Abstract Syntax
   ...
   syntax.
*** Declarations
    The abstract syntax is given in figure [[syntax-for-declarations]].
     ...
     \begin{align*}
       \begin{array}{llll}
        ...
        Decl &= &\text{data } N\; ParCtx \text{ : } ExprCtx \rightarrow \text{ Set where} &\text{Declarations}\\
                  &&\quad(N \text{ : }  ExprCtx \rightarrow\text{} TyExpr \rightarrow N\; expr*)* &\\
             &| &\text{codata } N\; ParCtx \text{ : } ExprCtx \rightarrow\text{ Set where}& \\
         &&\quad(N \text{ : }  ExprCtx \rightarrow\text{} N\; expr* \rightarrow\text{} TyExpr)*& \\
    ...
    #+caption: Abstract Syntax Tree for Declarations
