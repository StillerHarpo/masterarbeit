...
\chapter*{Abstract}
  ...
  In this work I will first give a survey of coinductive types in these languages
...
* Introduction
  ...
  output. These functions don't depend on multiple value i.e. if they is no IO
  ...
  'foo' and 'bar', wouldn't make sense i.e. there is no defined output for these
  inputs. To prevent calls like these some functional programming languages
...
** Binary Product and Coproduct
   ...
   product must also depend on these values. This is the product, which used is
